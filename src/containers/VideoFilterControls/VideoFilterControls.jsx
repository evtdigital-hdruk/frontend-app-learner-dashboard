...
import useVideoFilterControlsData from './hooks';
import messages from './messages';

import './index.scss';

export const VideoFilterControls = ({
  sortBy,
  setSortBy,
  videoFilters,
}) => {
          ...
          ? (
            ...
            >
              ...
              <div className="filter-form-row">
                <FilterForm {...{ videoFilters, handleFilterChange }} />
              </div>
            ...
            >
              ...
              >
                <div className="filter-form-col">
                  <FilterForm filters={videoFilters} {...{ handleFilterChange }} />
                </div>
